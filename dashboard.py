...
def pagina_dashboard(utente):
    ...
    with col_scrivi:
        st.markdown("**Scrivi**")
        with st.popover("✉️ Nuova email", use_container_width=True):
    ...
    with col_fu_oggi:
        cfu1, cfu2 = st.columns([2, 1])
        cfu1.markdown("**Follow-up di oggi**")
        with cfu2.popover("➕ Nuovo"):
